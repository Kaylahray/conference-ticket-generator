        ...
        {options.map((option) => {
          ...
          return (
            <button
              ...
              aria-label={`${option.type} ticket - ${option.price === 0 ? "Free" : `$${option.price}`} - ${option.available} of ${option.total} available`}
            ...
            >
              <p className={`text-white ${roboto.className} text-2xl font-semibold leading-[110%]`}>
                {option.price === 0 ? "Free" : `$${option.price}`}
              </p>
              <div>
                <p className={`text-[#FAFAFA] ${roboto.className} text-nowrap text-base font-normal leading-[150%]`}>
                  {option.type}
                </p>
                <p className={`text-[#D9D9D9] ${roboto.className} text-sm font-normal leading-[150%]`}>
                  {option.available}/{option.total} available
                </p>
              </div>
            </button>
          );
